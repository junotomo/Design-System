...
declare function ToolTip({ triggerText, message, delayDuration }: ToolTipProps): react_jsx_runtime.JSX.Element;
declare namespace ToolTip {
    var displayName: string;
}

interface ToastingProps extends ComponentProps<typeof Toast.Root> {
    title: string;
    content: string;
    duration: number;
}
declare function Toasting({ open, duration, onOpenChange, title, content, ...props }: ToastingProps): react_jsx_runtime.JSX.Element;
declare namespace Toasting {
    var displayName: string;
}
...
export { Avatar, type AvatarProps, Box, type BoxProps, Button, type ButtonProps, CheckBox, type CheckBoxProps, Heading, type HeadingProps, MultiStep, type MultiStepProps, Text, TextArea, type TextAreaProps, TextInput, type TextInputProps, type TextProps, Toasting, type ToastingProps, ToolTip, type ToolTipProps, config, createTheme, css, getCssText, globalCss, keyframes, styled, theme };
