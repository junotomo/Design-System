...
declare function Toasting({ title, message, duration }: ToastingProps): react_jsx_runtime.JSX.Element;

export { Avatar, type AvatarProps, Box, type BoxProps, Button, type ButtonProps, CheckBox, type CheckBoxProps, Heading, type HeadingProps, MultiStep, type MultiStepProps, Text, TextArea, type TextAreaProps, TextInput, type TextInputProps, type TextProps, Toasting, type ToastingProps, ToolTip, type ToolTipProps };
